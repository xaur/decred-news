...
The majority of the work this month was developer-focused, and not necessarily user-focused. However, it's always interesting when a new Go version is supported, because it unlocks potential new features and improvements from the coding language itself.

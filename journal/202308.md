...
- Fixed a bug where the VSP client was not updating ticket's [live and expiry block heights](https://github.com/decred/dcrwallet/pull/2270) after it was mined. The impact of this bug was an unreasonable delay before the ticket's VSP fee was considered confirmed. There was no risk of tickets not being added to wallets or of votes being missed. Backported change is [here](https://github.com/decred/dcrwallet/commit/1319da0b05d4a9715b045e847ff58b442f407f39).
  - { _Optionally comment on (a) how often it occurred for end users (always or in some % of cases), (b) was it purely a client-side bug or was incorrect data sent to the VSP?, (c) were wrong heights fixed automatically after some time/restart/rescan or did they persist forever?_ }
...
{ _Discover and greet new first-time contributors. For writers, list authors who published notable Decred content for the first time. Sort by type (dev/writing/etc.), then alphabetically._ }

...
_Image: Cryptopower has simple send form and advanced Coin Selection for extra privacy_
...
- Dropped official support for Go 1.19, and [added support for Go 1.21.0](https://github.com/decred/dcrd/pull/3172) (Go 1.20 is still supported as well). This included updates to the build and test actions, as well as updating the GitHub Actions build workflow `setup-go` and linter to their latest verisons.
  - { _let's clarify what "official support" is, i.e. is building with Go 1.19 still possible as go.mod says?_ }
...
- Updated the interal tool used to automatically generate gRPC files to use a [newer Docker image](https://github.com/decred/dcrwallet/pull/2280) with the latest Go 1.21.0 version. {_dev, may group (minor)_}
...
- Added [staking support foundations](https://github.com/decred/dcrdex/pull/2290) (not yet exposed on the UI).

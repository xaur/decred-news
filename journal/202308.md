...
_Image: Ticket price has been unusually stable in August
...
{ _Optional_ } Decred's [Lightning Network](https://ln-map.jholdstock.uk/) explorer has seen 213 nodes (-6), 431 channels (-14) with a total capacity of 186 DCR (-3), as of Sep 1. These stats are different for each node. For example, @karamble's node reported 217 nodes (-3), 453 channels (-11) and 192 DCR (+1) capacity on same day Sep 1.
...
- BTC-ECHO updates https://proposals.decred.org/record/49e373b
- Lindsey on PR vs marketing

...
- *Block hash* remained unchanged too; it is the same BLAKE-256 14-round hash of the *block header*. Most Decred software and code uses block hash to identify blocks and needs no modifications.

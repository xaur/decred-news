...
The chain has paused for almost 3 days until CPU miners found the first blocks and everything got running again. We will cover early CPU and GPU mining developments in the next issue. As of writing everything looks stable again and more upgrades are in the pipeline.

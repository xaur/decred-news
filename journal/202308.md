...
- https://github.com/crypto-power/cryptopower/releases/tag/release-v1.0.0
- highlights
- sigs
- link to the proposal
- where to report bugs/ideas
- about dev
  - https://www.cypherpunktimes.com/introducing-decred-developer-dreacot/
- https://www.cypherpunktimes.com/cryptopower-golang-native-desktop-mobile-wallet/
- demo vid
  - https://twitter.com/dreacot/status/1694260734878712220
...
Developers interested to contribute can join the #cryptopower and #cryptopower-dev chat rooms. See [this guide](https://docs.decred.org/getting-started/joining-matrix-channels/) for how to join Matrix.

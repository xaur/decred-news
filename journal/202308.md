...
- Updated the build and test actions to [support Go 1.21](https://github.com/decred/dcrd/pull/3172), and dropped official support for Go 1.19. This included updating the Github Actions build workflow `setup-go` and linter to their latest verisons.

...
- Fixed some error-handling logic and added new error logs [if processing VSP tickets fails](https://github.com/decred/dcrwallet/pull/2259).
  - { _what bugs were experienced by end users when `NotExist` errors were handled incorrectly?_ }
- Moved the logic of [finding VSP-managed tickets](https://github.com/decred/dcrwallet/pull/2259) out of the VSP client and into the main wallet code. This is part of the continued effort to refactor VSP and wallet logic. {_dev_}
- Added official [support for Go 1.21](https://github.com/decred/dcrwallet/pull/2278) and updated the GitHub Actions build workflow. {_user_}
- [Replaced](https://github.com/decred/dcrwallet/pull/2265) all non-generated uses of `interface{}` with `any` in the codebase. While `any` is just a new alias, it makes the code easier to read. {_dev_}

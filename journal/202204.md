...
- DCRDEX updated to [v0.4.3](https://github.com/decred/decrediton/pull/3748) with some new features and important bug fixes. More in the [DEX](#dcrdex) section.
...
- More automated UI testing coverage. { 3743 }

- ~{ 3735 3734 3741*3 } bug fixes.

{ image candidates: 3669! 3730 3733 3734 3743 }

...
- Client now sets atomic-swap [confirmation deadlines](https://github.com/decred/dcrdex/pull/1552) per asset. { maybe too small/internal }
...
- [Zcash](https://github.com/decred/dcrdex/pull/1570) support. Note: Wallet does not support encryption, so no passwords.

{ image candidates: 1589 }
...
{ new merged code contributors:

- https://github.com/decred/dcrdex/pull/1578

...
- {THe DEX [login will be skipped](https://github.com/decred/decrediton/pull/3749) once the DEX is launched. This should smooth out the working flow and make loading up the Dex window faster.}

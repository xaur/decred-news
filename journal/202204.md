...
{ image: custom by Exitus and/or 1589; check size, maybe move to the bottom to not steal all attention from the quote below }
...
{ image: staking % ATH from bochinchero }
...
- [Insaf Nori](https://twitter.com/in_insaf/status/1506976446044114944) (@arij) was invited to talk about [Blockchain Technology](https://decredcommunity.github.io/events/index/20220326.1) and Decred Technology at the half-day training organized for the members of AEFDS Deroua.
...
{ images: DEX vol DCR, DEX vol from dcrdata }

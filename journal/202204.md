...
Distribution of hashrate [reported](https://miningpoolstats.stream/decred) by the pools on May 10: poolin.me 52%, viabtc.net 24%, f2pool.com 8%, antpool.com 6%, luxor.tech 5%, pool.btc.com 3%, coinmine.pl and okx.com less than 1%.

Distribution of 1,000 blocks actually [mined](https://miningpoolstats.stream/decred) before May 10: poolin.me 51%, viabtc.net 16%, iocnsoWYKbVeYHt 9%, luxor.tech 4%, btc.com 4%, f2pool.com 3.6%, coinmmine.pl 0.4%, I9KHVGMpeL2cRD 0.1%, Unknown 12%.
...
Node versions as of May 10 [snapshot](https://nodes.jholdstock.uk/user_agents) 187 total: dcrd:1.7.1 49%, dcrd:1.7.0, 17%, dcrd:1.7.0(pre) 9%, dcrd:1.6.2 5%, dcrd:1.8.0(pre) 4%, dcrd:1.6.0 2%, dcrd:1.7.2 2%, dcrd:1.5.2 2%, other 7%.

The share of [mixed coins](https://dcrdata.decred.org/charts?chart=coin-supply&zoom=jz3q237o-la8vk000&scale=linear&bin=day&axis=time&visibility=true-true-true) varied between 57.9%-59.3%. Daily [mixed amount](https://dcrdata.decred.org/charts?chart=privacy-participation&zoom=jzuht6o0-l33oao00&bin=day&axis=time) varied between 288K-446K DCR.

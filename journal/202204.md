...
- Added an info icon explaining how transaction [byte size](https://github.com/planetdecred/dcrandroid/pull/606) is determined.
...
- [Privacy account](https://github.com/planetdecred/dcrios/pull/906) setup UX has been optimized.
...
- New [Proposals UI](https://github.com/planetdecred/dcrios/issues/890).
- The capability for [consensus voting](https://github.com/planetdecred/dcrios/issues/889).
...
- New [add wallet](https://github.com/planetdecred/godcr/pull/897) button layout implemented. { maybe move to tweaks }
- [Staking updates](https://github.com/planetdecred/godcr/pull/888). { maybe move to fixes*2 }
...
- ~{ 871 862 880 850 887 886 859 860*2 905*3 } bug fixes
- ~{ 878 879 882 885 860*2 892 896 898 } tweaks

- Updates to the base [dcrlibwallet](https://github.com/planetdecred/dcrlibwallet) to bring new features and fixes to Android, iOS and GoDCR.
...
- https://github.com/decred/dcrdex/commits?author=Juneezee
- https://github.com/planetdecred/dcrandroid/commits?author=yaroyazeed

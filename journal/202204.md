...
- Fixed 3 [dark mode](https://github.com/planetdecred/dcrandroid/pull/608) related bugs.
- Fixed bug where the [add wallet](https://github.com/planetdecred/dcrandroid/pull/628) menu was missing.
- Various other bug fixes, tweaks, and optimizations.

![](https://user-images.githubusercontent.com/25265396/161649433-afbcfe73-23c7-4727-b9b9-2db59ae46c9f.png)
...
[GoDCR v1.7.0](https://github.com/planetdecred/godcr/releases/tag/v1.7.0) has been released on Mainnet. A total of 273 changed files with 16,508 additions and 10,106 deletions have been made since v0.9.0
...
@Juneezee ([dcrdex](https://github.com/decred/dcrdex/commits?author=Juneezee))!

@yaroyazeed ([dcrandroid](https://github.com/planetdecred/dcrandroid/commits?author=yaroyazeed))!
...
A [proposal](https://proposals.decred.org/record/1a290d8) to continue with phase 2 of @StakeShuffle\_ the twitter bot with $1,6840 was approved with 96% support and turnout of 55%.

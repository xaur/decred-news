...
- Fixed a bug where the Treasury Spending page [crashed with undefined](https://github.com/decred/decrediton/pull/3735) `treasuryPolicies`.
- Fixed [snackbar layout](https://github.com/decred/decrediton/pull/3734) bug.

{ image candidates: 3669! 3730 3733 3734 }

![TreasuryTab](https://user-images.githubusercontent.com/46197055/168204530-770b6d39-3bbf-41fe-9ec5-46e74cec025b.png)
...
![DEX Registration](https://user-images.githubusercontent.com/9373513/163723857-98e6d254-aa11-4294-a737-3758336434ec.png)
...
All of the consensus changes deployed as part of the v1.7 release (DCP0007-DCP0010) were approved by voters with very similar voting outcomes: 99.9% approval of the 60% of tickets that voted (as opposed to abstaining, which ~40% did), there were just 61 votes against the subsidy split change. The changes activated on May 8, so along with the new subsidy split there are automatic ticket revocations, and explicit version upgrades.

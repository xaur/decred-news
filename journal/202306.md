...
- Modified the vote logic so that, after block height 777240, [stakers will no longer approve blocks with old block versions](https://github.com/decred/dcrd/pull/3137). This change forces miners to upgrade to the latest block version in a timely fashion so that voting on the new consensus changes can commense.
- [Removed module replacements](https://github.com/decred/dcrd/pull/3139), and [released 1.8.0](https://github.com/decred/dcrd/pull/3140).

DCP-11: Change PoW to BLAKE3 and a new difficulty algorithm using Absolutely Scheduled Exponentially weighted Rising Targets (ASERT)
...
- Updated to the latest [dcrtest](https://github.com/decred/dcrd/pull/3142), and cleaned up [unused required modules](https://github.com/decred/dcrd/pull/3143).

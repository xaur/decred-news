...
- Ensured that the wallet can correctly [validate either V1 or V2 PoW blocks](https://github.com/decred/dcrwallet/pull/2240), and updated the vote version.
- Prepared v1.8.0 release (and v3.0.0 module tag) by [bumping all Decred modules](https://github.com/decred/dcrwallet/pull/2241) to their latest versions and [updating the metadata](https://github.com/decred/dcrwallet/pull/2242).
...
- Removed mention of legacy [revocations](https://github.com/decred/dcrwallet/pull/2245).
- Updated [.gitignore](https://github.com/decred/dcrwallet/pull/2246) to ignore test databases.
...
- Brought dcrwallet up to date with VSPD, and [reduced rependencies between the VSP client and dcrwallet](https://github.com/decred/dcrwallet/pull/2238). 
- [Updated tests](https://github.com/decred/dcrwallet/pull/2250) to account for Go 1.21 changes.
- Dropped [noisy logs](https://github.com/decred/dcrwallet/pull/2251) that were used for development.
- Removed a [redundant VSP pubkey check](https://github.com/decred/dcrwallet/pull/2255).
- Removed a [brittle test](https://github.com/decred/dcrwallet/pull/2253) that checked if the wallet DB was a specific version.
- [Added new tests](https://github.com/decred/dcrwallet/pull/2254) for serializing VSP data
- Made the VSP client responsible for the [VSP logger](https://github.com/decred/dcrwallet/pull/2256), rather than using a global logger.
- Cleaned up several VSP functions, as well as [improved how VSP client handles contexts](https://github.com/decred/dcrwallet/pull/2252).
- Removed a deprecated [AddressReuse config](https://github.com/decred/dcrwallet/pull/2258) option from the wallet.

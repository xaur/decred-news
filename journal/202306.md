...
- Ensure that the wallet can correctly [validate either V1 or V2 PoW blocks](https://github.com/decred/dcrwallet/pull/2240), and update the vote version.
- Prepare v1.8.0 release (and v3.0.0 module tag) by [bumping all Decred modules](https://github.com/decred/dcrwallet/pull/2241) to their latest versions and [updating the metadata](https://github.com/decred/dcrwallet/pull/2242).
...
- Remove mention of legacy [revocations](https://github.com/decred/dcrwallet/pull/2245).
- Update [.gitignore](https://github.com/decred/dcrwallet/pull/2246) to ignore test databases.
- Update the [README](https://github.com/decred/dcrwallet/pull/2247) for people building from source.
- Bump the major module version of the in-dev [dcrwallet module](https://github.com/decred/dcrwallet/pull/2248) to v4 to prepare for future changes.
- Bring dcrwallet up to date with VSPD, and [reduce rependencies between the VSP client and dcrwallet](https://github.com/decred/dcrwallet/pull/2238). 
- [Update tests](https://github.com/decred/dcrwallet/pull/2250) to account for Go 1.21 changes.
- Drop [noisy logs](https://github.com/decred/dcrwallet/pull/2251) that were used for development.
- Remove a [redundant VSP pubkey check](https://github.com/decred/dcrwallet/pull/2255).
- Remove a [brittle test](https://github.com/decred/dcrwallet/pull/2253) that checked if the wallet DB was a specific version.
- [Add new tests](https://github.com/decred/dcrwallet/pull/2254) for serializing VSP data
- Keep the [VSP logger](https://github.com/decred/dcrwallet/pull/2256) inside the VSP client, instead of the global logger.
- Clean up several VSP functions, as well as [improve how VSP client handles contexts](https://github.com/decred/dcrwallet/pull/2252).
- Remove a deprecated [AddressReuse config](https://github.com/decred/dcrwallet/pull/2258) option from the wallet.
- The VSP client doesn't need to handle [unmanaged (non-VSP) tickets](https://github.com/decred/dcrwallet/pull/2257). Move the logic of unmanaged tickets out of the VSP client module and into the wallet module.

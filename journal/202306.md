...
- Removed mention of legacy [revocations](https://github.com/decred/dcrwallet/pull/2245). { _ticket revocations_ }
...
- Dropped [noisy logs](https://github.com/decred/dcrwallet/pull/2251) that were used for development.
- Removed a [redundant VSP pubkey check](https://github.com/decred/dcrwallet/pull/2255). { _may group (VSP refactor)_ }
- Removed a [brittle test](https://github.com/decred/dcrwallet/pull/2253) that checked if the wallet DB was a specific version. { _may group (tests)_ }
...
- Cleaned up several VSP functions, as well as [improved how VSP client handles contexts](https://github.com/decred/dcrwallet/pull/2252). { _may group (VSP refactor)_ }
- Removed a deprecated [AddressReuse config](https://github.com/decred/dcrwallet/pull/2258) option from the wallet. { _may comment on replacement config, if any_ }
- The VSP client doesn't need to handle [unmanaged (non-VSP) tickets](https://github.com/decred/dcrwallet/pull/2257). Moved the logic of unmanaged tickets out of the VSP client module and into the wallet module.

{ _vspd refactoring has quite a few bullets now, may put them in their own section_ }

...
- Updated the [package.json](https://github.com/decred/decrediton/pull/3872) metadata for official publications, as part of the [work done](https://github.com/microsoft/winget-pkgs/pull/106493) to add Decrediton to the [winget](https://en.wikipedia.org/wiki/Windows_Package_Manager) package repository.
...
- Updated [web dependencies](https://github.com/decred/decrediton/pull/3876) and removing old files.

...
For an [example](https://github.com/xaur/decred-news/pull/182#discussion_r1265803246) of difficulty adjustment speed, in a hypothetical scenario where the hashrate suddenly drops from 100 Ph/s to 20 Phs, returning to the target block time of 5 minutes would take ~75 hours (~3.1 days) under the old algorithm versus 20-30 mins under the new ASERT algorithm.
...
{ _image: [Initial Sync Total Bytes Used Comparison](https://matrix.to/#/!zefvTnlxYHPKvJMThI:decred.org/$mbJD22XpiecybtWfRIhFRTawODG9wQujjoKSyOqegI0) - total memory allocated. Less is better for lower CPU load and faster sync times.Also move this image up._ }
...
Decred Vanguard Outreach Update:

The Vanguard strives forward, brainstorming new ideas, creating art, and looking for opportunities to push the Decred Protocol.
...
$100 Prize Winners For This Month:
...
Decred Vanguard is recruiting! Participants get a flat stipend of $100 month and their twitter blue paid for by the Decred DAO. See the [proposal](https://proposals.decred.org/record/0a1b782) for more details.
...
- [Privacy Mixing in Decrediton](https://youtu.be/fQpdGi57x-M) by @phoenixgreen — also as a [text post](https://www.cypherpunktimes.com/decrediton-privacy-mixing-with-stakeshuffle/)
- [Crypto Unity - Building Decentralised Bonds - State of the market](https://youtube.com/live/CPQpP7K6EN8?feature=share) by @phoenixgreen, @exitus, and @tivra featuring @johnnylaw.dgb, @ZecHub, and  @LTCUnderground 
- [Consensus upgrade voting with Decrediton](https://youtu.be/5klbCo6HzD4) by @phoenixgreen — also as a [text post](https://www.cypherpunktimes.com/consensus-upgrade-voting-with-decrediton/)
- [Bison Relay wallet features](https://youtu.be/VZe-3T7k-24) by @phoenixgreen — also as a [text post](https://www.cypherpunktimes.com/bison-relay-wallet-features/)

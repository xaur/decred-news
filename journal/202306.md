...
- Significantly reduced the [initial deposit required for bonds](https://github.com/decred/dcrdex/pull/2392), from 0.056 BTC ($1,500) around 0.0035 BTC ($100). This will make it easier to onboard new users. Note that bonds can be funded with DCR too.

...
- Updated the [package.json](https://github.com/decred/decrediton/pull/3872) metadata for official publications, as part of the work done to add Decrediton to the [winget](https://en.wikipedia.org/wiki/Windows_Package_Manager) package repository.
...
- Other minor updates and fixes including some typos, translation updates, and bumping dependencies.
- [Released v1.8.0](https://github.com/decred/decrediton/pull/3878)

The following work has been merged in `master` towards future releases:

- Minor changes like updating dependencies and removing old files.
- Updated to [Electron v23.3.8](https://github.com/decred/decrediton/pull/3884). Among other things, this gives devs the ability to let Decrediton communicate over USB, which is required for some hardware wallets like Ledger.
- Updated to [DEX v0.6.2](https://github.com/decred/decrediton/pull/3882), which is required to follow the Decred 1.8.0 hard forks due to consensus changes.
- Added an [Arabic translation](https://github.com/decred/decrediton/pull/3847). { _not a new translation so "Updated"_ }
- Replaced placeholder text for the [intro tutorials](https://github.com/decred/decrediton/pull/3881).

...
- Brought dcrwallet up to date with VSPD, and [reduced rependencies between the VSP client and dcrwallet](https://github.com/decred/dcrwallet/pull/2238). { _may also mention the bigger goal of extracting vspd code_ }

...
- Improved [help text explaining bonds](https://github.com/decred/dcrdex/pull/2395) in the registration flow. This is based on feedback from the community and other users new to Decred
- BTC: Optimized the [initial deposit required for bonds](https://github.com/decred/dcrdex/pull/2382) to be much lower, ~0.004 BTC ($100) versus the ~0.06 BTC (~$1,500). This was an issue when onboarding new users.
- Updated to latest dcrd and dcrwallet [modules](https://github.com/decred/dcrdex/pull/2403) from the v1.8.0 release.
- Fixed a bug where registration flow could proceed [without waiting for sufficient bond funds](https://github.com/decred/dcrdex/pull/2382) to be deposited.
- Fixed a bug where the Settings page was using incorrect [fund amounts](https://github.com/decred/dcrdex/pull/2395) for bonds.
- Workaround Badger database [truncation error](https://github.com/decred/dcrdex/pull/2388) which may happen on [Windows](https://github.com/dgraph-io/badger/issues/744). { _opt: explain what is "truncation" and if it may cause data loss_ }

...
- [Persist](https://github.com/companyzero/bisonrelay/pull/257) received but not fully processed group chat messages. This helps to show messages in the correct order.
...
- Allow store admin to [add comments](https://github.com/companyzero/bisonrelay/pull/260) to the order, and show them on both admin and client order pages.

...
{ _Optional_ } Decred's [Lightning Network](https://ln-map.jholdstock.uk/) explorer has seen 212 nodes (+1), 427 channels (+4) with a total capacity of 191 DCR (+15), as of Jul 1. These stats are different for each node.

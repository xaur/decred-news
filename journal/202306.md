...
- Ensured that the wallet can correctly validate blocks mined with either the [original BLAKE-256 or the upcoming BLAKE3](https://github.com/decred/dcrwallet/pull/2240) proof-of-work, and updated the vote version.
- Preparations for v1.8.0 release: updated [Decred modules](https://github.com/decred/dcrwallet/pull/2241) to their latest versions, and released dcrwallet v3.0.0 module (it is used by software building on top of dcrwallet, such as DEX or vspd). { _skip 2242 (minor)_ }
...
- Brought dcrwallet up to date with vspd, and [reduced dependencies](https://github.com/decred/dcrwallet/pull/2238) between the VSP client and dcrwallet. This is part of a bigger task to extract VSP code from dcrwallet and consolidate it in the vspd repository.
- [Updated tests](https://github.com/decred/dcrwallet/pull/2250) to account for Go 1.21 changes. { _may group (tests)_ }
- Dropped [noisy TSpend logs](https://github.com/decred/dcrwallet/pull/2251) in SPV mode that were used for development. { _may group (too small)_ }
- Removed a [redundant VSP pubkey check](https://github.com/decred/dcrwallet/pull/2255). { _may group (VSP refactor)_ }
- Removed an [unneeded test](https://github.com/decred/dcrwallet/pull/2253) for the database upgrade code. { _may group (tests)_ }
...
- Cleaned up several VSP functions, as well as [fixed how VSP client handles contexts](https://github.com/decred/dcrwallet/pull/2252). { _may group (VSP refactor)_ }

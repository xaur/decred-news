...
- added [overview](https://github.com/decred/dcrdex/pull/1232) of current prices and 24-hour changes to the left sidebar, and a new subscription to spot price updates for all markets
...
- added function to initiate [batch](https://github.com/decred/dcrdex/pull/1251) multiple swaps in the same transaction (saves gas)
...
- show more details in proposal [tooltips](https://github.com/planetdecred/godcr/pull/638)

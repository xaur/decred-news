...
@rstaudt2 [shared](https://twitter.com/rstaudt2/status/1443956206473711617) and educational thread about what "UTXO cache" is, how Decred's implementation compares to Bitcoin Core's, and how it will be key to improving sync performance in the upcoming v1.7.

fuzz testing:

- https://github.com/degeri/dcrd-continuous-fuzz
- https://matrix.to/#/!zefvTnlxYHPKvJMThI:decred.org/$H-xE3xIdE8-0WXPnk91Ft7T5g5w5TDLFDFROou2b8Ww
...
In October the new [treasury](https://dcrdata.decred.org/treasury) received {n} DCR worth ${} at month's average rate of ${}. {} DCR was spent to pay contractors, worth ${} at October's rate, or ${} at September's billing rate of ${}. As of {date}, combined balance of [legacy](https://dcrdata.decred.org/address/Dcur2mcGjmENx4DhNqDctW5wJCVyT3Qeqkx) and [new treasury](https://dcrdata.decred.org/treasury) is {n} DCR ({n} million USD at ${n.nn}).

...
- Politeia celebrated its third year of operation
- mobile wallets funded for another year, GoDCR rejected but is preparing a revised proposal
...
- support multiple [HD accounts](https://github.com/decred/dcrdex/pull/1210) for same app seed, to allow registering additional accounts after initial account is suspended. This change also retires legacy accounts with random keys to ensure all new accounts can be derived from app seed.
...
- third year: 31 proposals published, 20 approved, 11 rejected, 2 abandoned
- average (mean) voter participation improved considerably with 46% in year 3, compared to 31% in year 1 and 28% in year 2
- software development proposals have increased in count, budgets, and support
- { maybe add a similar 1-sentence recap of how Marketing proposals have changed, I didnt grasp the big picture - @bee }
...
- all-time (3 years): 128 proposals published, of which 66 approved, 42 rejected, 20 abandoned
...
> 
> #Decred has recently produced it's 600 000th block.
> 
...
- GoDCR demo Oct 9 https://twitter.com/planetdecred/status/1446927031887745027

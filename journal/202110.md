...
- updating of indexes (transaction, address, exists address) has been made [asynchronous](https://github.com/decred/dcrd/pull/2219) to speed up the critical path of block validation and connection code { any other big picture or fun stuff to mention for it? and does it help multipeer downloads? }

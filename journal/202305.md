...
- Allow the wallet to [follow the DCP0012 hard fork](https://github.com/decred/dcrwallet/pull/2232) if it is approved and activated.
- Remove several [deprecated internal methods](https://github.com/decred/dcrwallet/pull/2235), namely those made obsolete by the consensus changes [DCP0009](https://github.com/decred/dcps/blob/master/dcp-0009/dcp-0009.mediawiki) (Automatic Ticket Revocations) and [DCP0010](https://github.com/decred/dcps/blob/master/dcp-0010/dcp-0010.mediawiki) (Change PoW/PoS Subsidy Split to 10/80).

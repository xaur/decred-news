...
- Added [full node wallet](https://github.com/decred/dcrdex/pull/2270) support for [Firo](https://firo.org/) (formerly known as Zcoin). Up next is Electrum-based [light wallet](https://github.com/decred/dcrdex/issues/2346) support. { _first-time contrib to Decred code?_ }

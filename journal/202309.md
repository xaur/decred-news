...
- [AtomicSwap refunds in DCRDEX](https://www.youtube.com/watch?v=W9dDnE6AdIs) by @phoenixgreen
...
- [Upgrading DCRDEX standalone version](https://www.youtube.com/watch?v=IIJ0SWAuwr8) by @phoenixgreen
...
- [Decred’s Blockchain Mining Revolution – Moving Blockchain Forward](https://www.youtube.com/watch?v=Ev7XRQ_VrnI) by @phoenixgreen - also on [Spotify](https://podcasters.spotify.com/pod/show/cypherpunktimes/episodes/Decreds-Blockchain-Mining-Revolution--Moving-Blockchain-Forward-e29f8ji)
- [Removing Centralisation from Crypto - Moving Forward](https://www.youtube.com/watch?v=746-gBoVcCE) by @phoenixgreen - also on [Spotify](https://podcasters.spotify.com/pod/show/cypherpunktimes/episodes/Removing-Centralisation-From-Crypto-e29rhvn)
- [How-To DCRDEX on Raspberry Pi with Umbrel](https://www.youtube.com/watch?v=hnXic_tVwr0) by @karamble

Audio versions of some videos are published on the [Cypherpunk Times](Cypherpunk Times) Spotify podcast.
...
- Decred GPU mining tutorials for [Linux and Windows](https://www.youtube.com/watch?v=Xsx6uaFA8x4) and for [HiveOS](https://www.youtube.com/watch?v=sxuBNhYe9G0) [Makertronic](https://www.youtube.com/channel/UCsm-K1pBCJiH_g2K3_TbUyg) in French (English subtitles available).

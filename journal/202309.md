...
After 24 hours of no blocks miners faced an issue where dcrd would refuse to mine on top of old blocks. The workaround was to set back the clock and regenerate certificates if necessary.

Block [794,369](https://dcrdata.decred.org/block/655d0c998b6f838a63a69991ebfb8dc776ed0234117c7b6cca407fe15c2cb02c) was eventually mined on September 1st and the chain got moving again. Some dcrd nodes had to be restarted due to hitting a path where they weren't trying to fetch new blocks. After that last issue was resolved, the difficulty was quickly adjusted by the new ASERT algorithm and block times normalized within hours.
...
![]({ upload 202309.xx TSpuyuYWgkTrgPTcXh,decred.org,EvRM2Dmf7-9ntW6wQqHEOctGia3FEa_-uQxs3d1yZwQ })
...
![]({ upload 202309.xx GHnoHXSgkVAsUknRUg,decred.org,f_MgbXpHSIzdI4RWsprpF6jsF4XH7HCWhCcDweEuUqo })
...
![]({ upload 202309.xx https://github.com/decred/vspd/pull/451 })
...
- Removed ["bonus tiers"](https://github.com/decred/dcrdex/pull/2502), which were an "accounting curiosity" on the server that didn't do anything for the client but did introduce a bug where client's bonds could fully expire before being replaced.
...
- Fixed the possibility of unexpected [bond expiration](https://github.com/decred/dcrdex/pull/2460) and cancellation of all orders. It was caused by the concept of "bonus tiers" and incorrect guessing of account's trading tier on the client side.
...
![]({ upload 202309.xx - combine 2482.1 and 2482.4 })

_Image: Decred staking UI in DCRDEX_

![]({ upload 202309.xx https://github.com/decred/dcrdex/pull/2431#pullrequestreview-1541903478 })
...
- Implemented new [Home page](https://github.com/crypto-power/cryptopower/pull/65) design with [dummy data](https://github.com/crypto-power/cryptopower/pull/75) and reorganized features into 3 high-level tabs: Overview, Wallets and Trade.
...
![]({ upload 202309.xx https://github.com/crypto-power/cryptopower/pull/63 })

_Image: Proposal voting in Cryptopower_

![]({ upload 202309.xx https://github.com/crypto-power/cryptopower/pull/64 })

_Image: Recent trades in Cryptopower use centralized instant exchange services_

![]({ upload 202309.xx https://github.com/crypto-power/cryptopower/pull/119 .2 })

_Image: DCRDEX onboarding pages in Cryptopower_

![]({ upload 202309.xx https://github.com/crypto-power/cryptopower/issues/69 })
...
![]({ upload 202309.xx GHnoHXSgkVAsUknRUg,decred.org,-V7JOL7Lrjg_pEIYXSv8MG7wWdPJhsYB7QD6nzFrcu8 })

_Image: First iteration of mobile design in Bison Relay v0.1.9_

![]({ upload 202309.xx screenshot from karamble })

_Image: Pages in brclient v0.1.9_

![]({ upload 202309.xx https://matrix.to/#/!GHnoHXSgkVAsUknRUg:decred.org/$KOVDyL-MvWWWtKx_BqSCesI0KcYJuF4UoAStoHOZXSg })
...
![{ upload 202309.xx }](https://github.com/bochinchero/dcrsnapshots/blob/main/2023-09/700/Treasury_Monthly_Balance_USD.png?raw=true)
...
The initial difficulty value was manually set to target about 1.45 TH/s hashrate in [anticipation of GPU hashrate](https://matrix.to/#/!TSpuyuYWgkTrgPTcXh:decred.org/$mtTPqh-YoNoXn-Q8-Q8K0390wy28L4XrD8Udx9yDU6U), but it didn't immediately join the network and only CPU miners were active upon BLAKE3 activation. A single CPU achieves between ~5-75 megahashes per second (from old laptops to high-end CPUs). Assuming an "average CPU" as 20 MH/s, getting 1.45 *terahashes* would require some 72,500 CPUs. The first BLAKE3 block (794,368) was extremely lucky to be found in 50 minutes, assuming it was found with CPUs, but afterwards the chain stalled.

In a positive development, this incident activated many old and new community members to come together and push the chain forward. #pow-mining chat became very busy as people were converting any available hardware to Decred miners and enduring the generated heat. Devices ranged from tiny Raspberry Pi-s (1 MH/s), to old laptops (2-5 MH/s), to new laptops and desktops (10-20 MH/s), to monstrous 120 Watt+ processors with 16 and 32 cores (60-75 MH/s).

By the end of August 31st around 25 individuals reported a total of 550 MH/s but that (and any unreported hashrate) was still not enough. On early September 1st, @grumlin and @davecgh turned to [cloud hashrate](https://matrix.to/#/!TSpuyuYWgkTrgPTcXh:decred.org/$-Ql5Vva-X-A2ds34OYP0HZZs8O8fsikHIeTH6zlN9yU) and within ~3 hours [block 794,369](https://dcrdata.decred.org/block/655d0c998b6f838a63a69991ebfb8dc776ed0234117c7b6cca407fe15c2cb02c) was [found](https://matrix.to/#/!TSpuyuYWgkTrgPTcXh:decred.org/$s5YhsGnMnTGaWnNLHGWD6CSKXYfoTxNklSFeKuS7zb4), it was 324 KB in size and included 240 transactions accumulated over the days. Since no blocks were mined for so long the ASERT algorithm only needed one block to reduce the mining difficulty from ~97,000 to ~1,800, from there CPUs had no problem finding new blocks and target block time was restored in just a few hours.

}

GPU mining rigs did not immediately join as expected and home/hobby miners fired up dcrd's built-in miner on their CPUs to try and break the initial difficulty which targeted around 1.45 TH/s hashrate (equivalent to ~100 GPUs or ~72,00 CPUs).

The miner of the first BLAKE3 block was extremely lucky to find it in only 50 minutes. Second block was not so lucky and took 3 days to find. #pow-mining chat became very busy as people were joining and converting any available hardware to Decred miners, ranging from Raspberry Pi (1 MH/s), to old laptops (2-5 MH/s), to new laptops and desktops (10-20 MH/s), to monstrous 16 and 32-core 120 Watt+ processors (60-75 MH/s). By the end of August 31st around 25 individuals reported a total of 550 MH/s. That was still too low, so next day @grumlin and @davecgh purchased a bunch of cloud CPU firepower and the second block was finally [mined](https://dcrdata.decred.org/block/655d0c998b6f838a63a69991ebfb8dc776ed0234117c7b6cca407fe15c2cb02c).

September 1-5th was the short period when CPU mining was feasible as the difficulty settled around 500 and the corresponding network hashrate stayed between 6-10 GH/s, equivalent of ~300 CPUs or just 1 mid-range GPU. Mining address distribution became significantly more decentralized compared to the [ASIC era](https://proposals.decred.org/record/a8501bc/comments/66).

![]({ upload 202309.xx 20230905 TSpuyuYWgkTrgPTcXh,decred.org,oKwCLjopA06E3DmAbwHyezKJ6W5D9p4HQWETBkW08sA })

_Image: Mining difficulty during the CPU days_

![]({ upload 202309.xx 20230906 TSpuyuYWgkTrgPTcXh,decred.org,VwzH8Rky7m6Aoq14xSzhCy79Lw5vZybMhir7v56BLrs })

_Image: Block distribution by mining address as of September 6th_

CPU mining days did not last long. Developers anticipated that GPU miners would show up soon given that even a single GPU mines as fast as roughly 500 CPUs, and GPU *farms* are quite common. First signs of GPU mining got spotted around September 2nd but it wasn't definitive because they seemed to be intentionally keeping it in the range of plausible deniability. With a more reliable confirmation on the 5th developers rushed to add GPU mining support to [gominer](https://github.com/decred/gominer).

On September 6th a significant increase in block production rate was a clear indicator of GPU mining happening on the network. The hashrate increased to ~32 GH/s by 15:00, from ~9 GH/s a day before. In about one day rewards for ~150 blocks were collected by a single address (normally ~288 blocks are mined per day). First GPU mining [patch](https://github.com/decred/gominer/pull/194) was merged in gominer around 14:30 and by 15:30 first community members got their GPUs up and running. After GPU mining was made available for everyone the hashrate went straight up, reaching ~52 GH/s by 18:30 and [~700 GH/s](https://matrix.to/#/!TSpuyuYWgkTrgPTcXh:decred.org/$P9sXHlT3txgllOwHtrWLNVWpXSC10i0Dx9p6mImfMgw) by 20:00. New blocks were mining as fast as 100 per hour (the normal rate is 12 blocks/hour).

By late September 7th the hashrate reached the level expected on the fork day, around 1,500 GH/s or 150 GPUs (assuming a 10 GH/s GPU like RTX 3070). This was a good test of the new difficulty algorithm which was designed in anticipation of this scenario. It worked well, ASERT managed to return block times to normal ~5 minutes by September 10th despite the hashrate increasing to ~3,000 GH/s in the same period. With the old algorithm it would take 2 weeks in the best case.

Soon after gominer was in a good shape the developers switched to refreshing the codebase and adding BLAKE3 support in [dcrpool](https://github.com/decred/dcrpool). BzMiner developer @iedoc released BzMiner v17.0.0 with Decred mining support, capable of squeezing out a few extra gigahashes from the GPU compared to gominer.
...
![]({ upload 202309.xx diff chart })

_Image: Mining difficulty increased x200 in just 2 days, and made another x5 through the rest of September_

![{ upload 202309.xx }](https://github.com/bochinchero/dcrsnapshots/blob/main/2023-09/700/Network_Daily_BlockTime.png?raw=true)

_Image: Average block time was wild for a few days but stabilized quickly_

![{ upload 202309.xx }](https://github.com/bochinchero/dcrsnapshots/blob/main/2023-09/700/Network_Daily_PoW_AddressCount.png?raw=true)

_Image: This chart shows just how centralized the mining was before the fork, only ~5 unique mining addresses_

![{ upload 202309.xx }](https://github.com/bochinchero/dcrsnapshots/blob/main/2023-09/700/Daily_PoWRewardDist.png?raw=true)
...
Decred's network upgrade and the corresponding technical issues have created volatility in several metrics as seen on the charts below but most metrics have normalized by the end of September or early October.
...
Thanks to @bochinchero for providing and improving these charts. About 40 other charts not used in this Decred Journal issue are available in the [dcrsnapshots](https://github.com/bochinchero/dcrsnapshots) repository, everyone is welcome to post them on social media.
...
- [Staking - is it worth it?](https://www.youtube.com/watch?v=ItlHeKohvO4) by @Exitus - first in @DecedTV Shorts tab
...
- A [revolutionary paradigm](https://matrix.to/#/!lDZCzVQjFoJsXMPkvr:decred.org/$-k2e-8QCXjQ04mv7LqYyW2WALIb5wDvX-jRqWrc5Dk4) in crypto charts from @Tivra
- [@dearcryptopunk](https://www.tiktok.com/@dearcryptopunk) TikTok videos by @jp.santanna

> We need a new, revolutionary paradigm in crypto charts, especially DCR/BTC and DCR/USDT
New paradigm: Up Only  
> As a self-professed leader of radical UpOnlyism, I declare: death to those who says our charts should move anywhere but UP  
> Behead those who say any pump requires some retracement!  
> In the luminous cosmos of infinite possibilities, let it be decreed that from this hallowed moment forth, our journey shall trace only the noblest of paths, soaring ever upwards. Through realms untrod and vistas unseen, let our aspirations burgeon and unfurl like the finest vines under the golden kiss of the morning sun. May prosperity grace our endeavours with an unwavering embrace, leading us to heights unparalleled, where glory and fortune await to shower their benevolent favors upon us. Onwards, to realms resplendent with abundance and richness, where our charts, in harmonious accord with the universal symphony, shall resonate with the grandeur of an unyielding ascent. Up, ever up, we command thee!  
> UP ONLY  
> WHERE we are going, you won't need EYES to see the charts  
> You will have direct gnostic access to the noumenon itself, you will know, a priori, apodictically: UP ONYL [[@Tivra](https://matrix.to/#/!lDZCzVQjFoJsXMPkvr:decred.org/$-k2e-8QCXjQ04mv7LqYyW2WALIb5wDvX-jRqWrc5Dk4)]

{ _^ not sure if it's worth including due to size, maybe cut or remove_ }

![]({ upload 202309.xx https://twitter.com/CryptoDYOR/status/1703054462686777695 })

_Image: Interpretation of the UP ONYL paradigm by @Void_

![]({ upload 202309.xx https://matrix.to/#/!TSpuyuYWgkTrgPTcXh:decred.org/$KKJXU4Z9VSUKR_RJ7oRW5KRdujThaM4JvSMSB3z8MIg })
...
![]({ upload 202309.xx https://matrix.to/#/!lDZCzVQjFoJsXMPkvr:decred.org/$z6W3BbBc7QI9i8KUo47-AHLKLG1bvjE76BH3Y06Ap3k })

_Image: Historical DCR/USD accumulation zones by @saender_

![{ upload 202309.xx }](https://github.com/bochinchero/dcrsnapshots/blob/main/2023-09/700/Markets_BTC_Price_Zoomed.png?raw=true)

_Image: Recent DCR/BTC, data from Coin Metrics_

![{ upload 202309.xx }](https://github.com/bochinchero/dcrsnapshots/blob/main/2023-09/700/Markets_USD_Price_Zoomed.png?raw=true)

_Image: Recent DCR/USD, data from Coin Metrics_

![{ upload 202309.xx }](https://github.com/bochinchero/dcrsnapshots/blob/main/2023-09/700/DEX_Monthly_Vol_USD.png?raw=true)

...
Decred mining has been rebooted on August 29th when ASICs mined their [last block](https://dcrdata.decred.org/block/0000000000000000c293d8c67409d05e960447ea25cdaf770e864d995c764ef0) and the network switched to BLAKE3. GPU mining rigs did not immediately join as expected and home/hobby miners fired up dcrd's built-in miner on their CPUs to try and break the initial difficulty which targeted around 1.45 TH/s hashrate (equivalent to ~100 GPUs or ~72,00 CPUs).
...
_Image: BzMiner v17 managing {} GPUs mining Decred_
...
_Image: This chart shows just how centralized the mining was before the fork_
...
Thanks to @bochinchero for providing these charts and continuously improving them. This Decred Journal uses only { 13 } charts but the [dcrsnapshots](https://github.com/bochinchero/dcrsnapshots) repository has 55 for September. All images are PNGs available in 3 sizes.

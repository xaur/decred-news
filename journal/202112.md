...
- contractor payments paid via the first treasury spend from the new treasury
- DCP10 dev work completed
- Politeia v1.3.1 bugfix and polishing release
- v1.7 RCs in early Jan
...
{ quick info how to join testing, testnet coins, how to report, etc }


## Vote on treasury spends

{ maybe have a standalone and more visible notice to prompt more votes on tspends https://twitterc.com/decredproject/status/1472050886830702597 }
...
Progress towards Ethereum support { simplify this list a bit }:

- implemented ~ { 1302 1319 1325 1332 1333 1334 1361 1363 } more core [methods](https://github.com/decred/dcrdex/issues/1154) out of a long 27-item checklist. Along the way the codebase is being continuously refactored to support account-based assets like Ethereum (originally DCRDEX was built for UTXO-based coins).
...
- simplified reorg [detection](https://github.com/decred/dcrdex/pull/1322)
- added a script to test [reorgs](https://github.com/decred/dcrdex/pull/1316)
- fixed client [balance](https://github.com/decred/dcrdex/pull/1321) calculation
- [keeping up](https://github.com/decred/dcrdex/pull/1309#issuecomment-977380539) with Ethereum's hardforks and toolchain's breaking changes
...
- made it harder to accidentally send from the [unmixed](https://github.com/planetdecred/godcr/pull/712) account
- ~17 bug fixes { 710 705x4 678 713 717 719x2 718x4 731 738 737 }
...
- Bug Bounty program posted a status [update](https://bounty.decred.org/2021/12/status-update/): all-time 209 submissions processed and 19 were eligible for a payout. One minor submission will be revealed once enough users update to the upcoming 1.7 release.
...
{ first tspend https://twitter.com/decredproject/status/1472050886830702597 }

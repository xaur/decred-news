...
Any help to make the final release better is greatly appreciated. Please report any issues in #support chat in [Matrix](https://chat.decred.org/#/room/#support:decred.org), [Discord](https://discord.com/channels/349993843728449537/350007452152102923), [Telegram](https://t.me/DecredSupport), or directly in the appropriate [GitHub repo](https://github.com/decred). Good bug hunting!


## Vote on Treasury Spends

Starting with the [payment](#governance) for November work, payments to contractors will be made from the new treasury following the decentralized voting process.
...
You can verify this key in the [DCP-0006](https://github.com/decred/dcps/blob/master/dcp-0006/dcp-0006.mediawiki) or in the [source code](https://github.com/decred/dcrd/blob/79f15b7f7269f3e139e1ce6ff7bf00d787a48a73/chaincfg/mainnetparams.go#L485). The voting is semi-automated with this one-time configuration, but it is possible to vote on individual tspend transactions when more granular control is needed.

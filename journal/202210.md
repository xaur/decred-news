...
- [Updated README.md](https://github.com/decred/dcrctl/pull/52) for v1.7.5 release. { _minor, just a link change, not worth the section_ }
...
- Bumped to [DCRDEX v0.5.4](https://github.com/decred/decrediton/pull/3816) which includes a critical fix to Bitcoin block parsing. { _group with the other DEX module bump_ }
...
- Added [types module](https://github.com/decred/vspd/pull/356) for API requests/responses/errors.

...
- Sorted [Software Releases](https://github.com/decred/dcrweb/pull/1094). { _minor, drop_ }
...
- [Removed](https://github.com/decred/dcrweb/pull/1084) "Decred in the Press" from footer. { _minor, remove_ }

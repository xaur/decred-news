...
- [Decred vs Zcash: an honest comparison](https://www.decredmagazine.com/decred-vs-zcash-a-honest-comparison/) by Joao Paulo Sant'Anna da Silva
- [Are privacy coins future proof?](https://www.decredmagazine.com/are-privacy-coins-future-proof/) by Ronnie Amato
- [Tiago Alves Dulce Developer Q&A](https://www.decredmagazine.com/tiago-alves-dulce-developer-q-a/) by Phoenix Green
- [Creation of marketing content for the crypto market](https://www.decredmagazine.com/creation-of-marketing-content-for-the-crypto-market/) by Joao Paulo Sant'Anna da Silva
...
- [Discovering DCRDEX Markets page - DCRDEX Fundamentals](https://youtu.be/67cduOxn7JM) by @PhoenixGreen - also as a [text post](https://www.decredmagazine.com/discovering-dcrdex-markets-page/)
- [DCRDEX First Look - DecredDEX Fundamentals](https://youtu.be/S4fVlYmo2Vk) by @PhoenixGreen - also as a [text post](https://www.decredmagazine.com/dcrdex-first-look-decreddex-fundamentals/)
- [Peer to Peer Exchange - The future is here - Decred DCRDEX](https://youtu.be/oBrJgG-x9UY) by @PhoenixGreen - also as a [text post](https://www.decredmagazine.com/peer-to-peer-exchange-the-future-is-here-decred-dcrdex/)
- [But Who is in Charge of Decred? - Decred and the state of the market feat. Eduardo Lima](https://youtu.be/COfKWnl7IYs) by @PhoenixGreen and @Exitus - discussing @elima\_iii's [research paper](https://twitter.com/elima_iii/status/1567977181682479105) ([GDoc](https://docs.google.com/document/d/1xiFYTU5aFthkUs9gIK1elNKJACsaZf4r/edit), [mirror](https://www.decredmagazine.com/whos-in-charge-of-decred-state-of-the-market/))
...
- [Decred is money evolved!](https://www.decredmagazine.com/decred-is-money-evolved/) by Official Cryptos
- [Decred holding all cards](https://www.decredmagazine.com/decred-holding-all-cards/) by Official Cryptos - merch with this artwork is [available on Redbubble](https://www.redbubble.com/people/OfficialCryptos/explore?page=1&sortOrder=recent)!

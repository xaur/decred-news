...
- Information on how to verify Lula's and Haddad's political plans on [timestamp.decred.org](https://timestamp.decred.org/) was published on [Fernando Haddad](https://en.wikipedia.org/wiki/Fernando_Haddad)'s [official website](https://haddadoficial.com.br/lula-e-haddad-registram-plano-de-governo-em-blockchain-para-evitar-fake-news/) (Portuguese). This story was also covered on [Cointelegraph Brasil](https://cointelegraph.com.br/news/lula-and-haddad-register-government-plan-on-blockchain) (independently from the [BeInCrypto](https://br.beincrypto.com/planos-governo-lula-haddad-registrados-blockchain/) story secured by Monde PR).

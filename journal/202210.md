...
- Added [types module](https://github.com/decred/vspd/pull/356) for API requests/responses/errors. { _submitted in Nov => can remove the section and report it later_ }
...
- [Bumped build](https://github.com/decred/dcrlnd/pull/167) to v0.3.7. { _minor, merge_ }

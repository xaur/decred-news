...
- UI fixes { 1736x2 1776 }
- Maintenance { 1753 1774 }

Ethereum support:

- Enabled [token trading](https://github.com/decred/dcrdex/pull/1622) on the UI with new wallet creation flow for token wallets that includes a step to sync the parent.

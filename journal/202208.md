...
- [What is the Decred Digital Token Project? {Decred Video in Arabic)](https://www.youtube.com/watch?v=B8Y3-z9Bs9A) by @BeCoin
- [Coin des Tages (Coin of the Day): Decred (DCR)](https://www.youtube.com/shorts/6PfekNUZq_k) by @KryptoZenny
- [DCR DecreD EXPLOSE J'ACHETE OU PAS?(Decred exploding, buy or not?)](https://www.youtube.com/watch?v=6cWhwYQ9tbE) by @CryptoforEveryOne

...
- Maintenance { 2980 2983 2981 }
- Small fixes { 2987, 2991 - may merge with maintenance }
...
- 4 fixes { 3783 3775 3784 3792 } and various backend updates.
...
- https://github.com/decred/politeia/releases/tag/v1.4.0
- https://github.com/decred/politeiagui/releases/tag/v1.4.0
...
- Freeze [Trillian trees](https://github.com/decred/politeia/pull/1670) that correspond to Politeia records that no longer allow updates (such as Censored or Archived). Politeia's use of Trillian is quite different from it's intended use case and it results in high CPU load. Freezing some trees should reduce it.
- Fixes { 1675 }
...
- Reuse [view breakpoints](https://github.com/decred/politeiagui/pull/2849) from pi-ui (these control at which screen width the layout changes to one that better fits user's screen size).
- Fixes { 2839 2853x3 2850 }
- Code refactoring and cleanup { 2834 2843 2854 }

{ image candidates: 2848 fun }
...
- Add 'EnforcePing' [RPC call](https://github.com/decred/dcrlnd/pull/163). This allows callers to direct 'dcrlnd' to ping a peer and wait for the response. If the response fails to be received, then the peer is disconnected.
- Add [stall detection and disconnection](https://github.com/decred/dcrlnd/pull/162) for peers. This is useful in detecting scenarios where the local peer stalled due to (for example) being previously suspended.
...
- Use epoch's first and last [match price](https://github.com/decred/dcrdex/pull/1781) for candle's start and end rate. This will produce more accurate candlestick chart.
...
- Adjusted [order cancellation](https://github.com/decred/dcrdex/pull/1682) policy to penalize too fast cancellations, but if the order sits for one full epoch it can be cancelled for "free" (without hurting user's reputation score). This should improve trading experience [for humans](https://github.com/decred/dcrdex/pull/1682#issuecomment-1165059876).
...
- Updated Node.js [dependencies](https://github.com/decred/dcrdex/pull/1792) for v0.6 dev cycle.
...
- Translated page templates are now generated [at runtime](https://github.com/decred/dcrdex/pull/1826). It removes the need to re-generate them manually and simplifies updating/adding new languages.
...
- Disable receive, send and mixer navigation option for [watch only wallets](https://github.com/planetdecred/godcr/pull/1051).
- Fix to top navigation [dark mode](https://github.com/planetdecred/godcr/pull/1049).
- Fix [app crash](https://github.com/planetdecred/godcr/pull/1048) after wallet restore is complete.
- Add v2 [wallet settings page](https://github.com/planetdecred/godcr/pull/1036).
- Fix crash in [proposal details](https://github.com/planetdecred/godcr/pull/1045).
- Update [top-level setting page](https://github.com/planetdecred/godcr/pull/1035) UI v2.
- Implement [layout for treasury spending](https://github.com/planetdecred/godcr/pull/975). (image candidate).
- Update [color and icon](https://github.com/planetdecred/godcr/pull/1028) on top bar navigation.
...
- Various updates and other fixes
...
- Update [Matrix support](https://github.com/decred/dcrweb/pull/1060) link.
- Remove [defunct exchanges](https://github.com/decred/dcrweb/pull/1059) and unmaintained wallets. Updated links.

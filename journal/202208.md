...
- [What is the Decred digital token project?](https://www.youtube.com/watch?v=B8Y3-z9Bs9A) by BeCoin (Arabic)
- [Coin des tages: Decred (DCR)](https://www.youtube.com/shorts/6PfekNUZq_k) by KryptoZenny ("Coin of the Day: Decred (DCR)")
- [DCR DecreD Explose j'achete ou pas?](https://www.youtube.com/watch?v=6cWhwYQ9tbE) by CryptoforEveryOne ("Decred exploding, buy or not?")

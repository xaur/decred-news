...
- Politeia v1.1.0 has been released and deployed to the proposals site, it adds many new features, including proposal reporting and expanded metadata.
...
Implementation of the [Revert Treasury Expenditure Policy](https://github.com/decred/dcps/blob/master/dcp-0007/dcp-0007.mediawiki) consensus change (DCP-7) has been [merged](https://github.com/decred/dcrd/pull/2680) (following some [preparations](https://github.com/decred/dcrd/pull/2679) to make it easier to review). If the vote passes, spend limit will be based on treasury's historical income and not its historical spends, which in turn unlocks the ability to use the new decentralized treasury.

...
dcrdata now shows [price](https://explorer.dcrdata.org/market?chart=candlestick&xc=dcrdex&bin=1d) and trading [volume](https://explorer.dcrdata.org/market?chart=volume&xc=dcrdex&bin=1d) history for the BTC/DCR pair at DCRDEX.

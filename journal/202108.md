...
The share of [mixed coins](https://dcrdata.decred.org/charts?chart=coin-supply&zoom=jyefppu5-kub1inpe&bin=day&axis=time&visibility=true-true-true) varied between 46.1-50.5% and made a new ATH. Daily [mixed amount](https://dcrdata.decred.org/charts?chart=privacy-participation&zoom=krmqf4vr-kt3wbm67&bin=day&axis=time) varied between 200-786K DCR and also set a new record.

{ any interesting analysis or events in the network }

- https://twitter.com/TheBochinchero/status/1433834350353784875
- https://twitter.com/lukebp_/status/1427980967789187076


## Ecosystem

Welcome the [new](https://github.com/decred/dcrwebapi/pull/147) VSP at [synergy-crypto.net](https://vspd.synergy-crypto.net/) with 0.75% fee. Extra thanks for running a [testnet](https://vspd-testnet.synergy-crypto.net/) instance.

The following legacy VSP have been removed from public [listing](https://decred.org/vsp/):

- [dcr.farm](https://dcr.farm) - its legacy page has been redirecting to [vspd page](https://vsp.dcr.farm/) since June (when it [had](https://github.com/decred/dcrwebapi/issues/146#issuecomment-865451784) 32 live tickets)
- [stakey.net](https://stakey.net) - the page shows stats of the new vspd instance now, but its [legacy API](https://stakey.net/api/v2/stats) is still up and reports how many live tickets remain (38 as of Sep 1)

raqamiya.net has shut down its legacy VSP. In March it was [delisted](https://github.com/decred/dcrwebapi/pull/132) and users were notified via email, website, and [March DJ](202103.md#integrations) about the upcoming shutdown. Raqamiya then continued to vote tickets for ~4 months before closing. Unfortunately, a few users missed all notices and continued assigning tickets to this VSP, resulting in 11 live tickets at the moment of shutdown. This can happen with any legacy VSP because [dcrstakepool](https://github.com/decred/dcrstakepool) has no way to prevent users from buying tickets to it (unlike the new vspd protocol).
...
@DecredKorea [reported](https://twitter.com/DecredKorea/status/1425751145796956167) that Hotbit Korea has delisted its DCR/KRW pair.

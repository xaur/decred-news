...
The share of [mixed coins](https://dcrdata.decred.org/charts?chart=coin-supply&zoom=jyefppu5-kub1inpe&bin=day&axis=time&visibility=true-true-true) varied between 46.1-50.5% and made a [new ATH](https://twitter.com/lukebp_/status/1427980967789187076). Daily [mixed amount](https://dcrdata.decred.org/charts?chart=privacy-participation&zoom=krmqf4vr-kt3wbm67&bin=day&axis=time) varied between 200-786K DCR and also set a new record.

Many new ATHs have been nicely summarized in @bochinchero's latest on-chain metrics [thread](https://twitter.com/TheBochinchero/status/1433834350353784875).

...
- a filter for fetching [unmined](https://github.com/planetdecred/dcrlibwallet/pull/205) tickets
...
- added desktop [notifications](https://github.com/planetdecred/godcr/pull/518) when a new receiving transaction or proposal is detected
...
- refactoring and code reuse { 547 536 577 }
- ~20 bug fixes { 3x545 2x577 2x559 2x582 }

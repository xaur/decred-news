...
- Default the GUI server to using [`127.0.0.1`](https://github.com/decred/dcrdex/pull/2283) IPv4 address when it is not specified in the config. This helps to satisfy the [Content Security Policy]({ mdn link }) protocol, which in turn is needed to workaround a bug in Safari. The new default avoids an issue where some [icons](https://github.com/decred/dcrdex/issues/1652) are not loading properly because of CSP failures. { _missed follow-up fix in 2295; simplify and/or group_ }
...
- Initial research to integrate [Firo](https://github.com/decred/dcrdex/pull/2270) (formerly known as Zcoin) has been started.
...
- v0.6.1 release is being [prepared](https://github.com/decred/dcrdex/milestone/30) with the most important fixes backported from `master`.
- Litecoin users are advised to upgrade their nodes to v0.21 https://twitter.com/chappjc/status/1645982431571329024
- Umbrel ann https://twitter.com/decredproject/status/1648439889678192640 { _worth its own ANN section? _}

{ image candidates: some of https://github.com/decred/dcrdex/pull/1993 }

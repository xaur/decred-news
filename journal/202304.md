...
{ _Decrediton and standalone links, sig reminder_ https://github.com/decred/dcrdex/releases/tag/v0.6.0 }
...
{ highlights, mention signatures are available now }
...
- Fixes to the [send form](https://github.com/decred/decrediton/pull/3855). { _clarify what exactly was fixed_ }
- Sped up the [wallet launcher](https://github.com/decred/decrediton/pull/3846) by removing the unnecessary `gettingVSPInfo` step. { _translate tech jargon, what was causing the delay? also mention the extra work in that PR_ }
- Updated to [dcrdex v0.6.0 release](https://github.com/decred/decrediton/pull/3857).
- Added the [ETH client asset](https://github.com/decred/decrediton/pull/3861), which was missing from the initial release. { _were v1.7.7 binaries rebuilt to add this fix?_ }

...
- LN keeps growing and surpassed node/channel count of Litecoin's LN
...
{ _image: new onboarding tutorials list OR one of the tutorials_ }
...
{ _image: DEX market view_ }

{ _image: DEX wallet view_ }
...
{ _image: best image showcasing new version_ }

{ _image: tipping in action https://twitter.com/DecredSociety/status/1646472964911648768_ }
...
{ _image candidates: prefer in progress stuff, some of 1993, 2313, shot of dex.decred.org with umbrel button_ }

{ _image: something showing DGB_ }

{ _image: site shot with Umbrel button_ }
...
{ _image candidates: 203 (rating 6), 204 (rating 7), 207 (maybe a frame from a gif?)_ }

{ _image: new on-chain wallet page_ }
...
_Image: Uptick in ["adjusted transaction volume"](https://coinmetrics.io/introducing-adjusted-estimates/) as defined by Coin Metrics, in both DCR and USD._
...
Decred's LN has surpassed Litecoin LN in node count (196 > 95) and channel count (399 > 170), and is getting close in capacity (to Litecoin's capacity (~$2,770 < ~$3,240 at $17 per DCR and $92 per LTC). This is based on [Litecoin LN data](https://1ml.com/litecoin/) from 1ML.com.

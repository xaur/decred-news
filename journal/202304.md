...
- Fixes to the [send form](https://github.com/decred/decrediton/pull/3855).
- Sped up the [wallet launcher](https://github.com/decred/decrediton/pull/3846) by removing the unnecessary `gettingVSPInfo` step.
- Updated to [dcrdex v0.6.0 release](https://github.com/decred/decrediton/pull/3857).
- Added the [ETH client asset](https://github.com/decred/decrediton/pull/3861), which was missing from the initial release.

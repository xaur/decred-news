...
Decred Vanguard is a new initiative to fund a community-driven outreach team with a budget of $46,784. There will be up to 25 paid positions for participants to receive $100/month, as well as $100 prizes for good contributions from inside and outside the Vanguard team. The [proposal](https://proposals.decred.org/record/0a1b782) was approved with 94%^ Yes votes and turnout of 39%. 
...
@jy-p's [proposal](https://proposals.decred.org/record/a8501bc) to change the reward distribution so that PoW miners get just 1% and the hashing algorithm changes was approved with 97% Yes votes and turnout of 62%. @bee has [compiled](https://github.com/decredcommunity/proposals/blob/master/proposals/a8501bc/qna.md) the most common questions and answers from the highly active comments on the proposal. The development work needed to implement the change has already been [merged](https://github.com/decred/dcrd/pull/3092) to master.
...
_Image: Uptick in transaction volume in both DCR and USD._

{ _^ explian what it means OR drop if too much charts_ }
...
- Bittrex charged by SEC - but we reported it March Eco, drop if nothing very relevant for DCR surfaces. Move to RE and link to #eco
- MetalPay removed https://github.com/decred/dcrweb/pull/1124 link 202303.md#ecosystem
- Trocador, works without js! https://github.com/decred/dcrweb/pull/1124
- Changes to comm channels, maybe in own ANN

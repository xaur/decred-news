...
Block size: This month, the blockchain size grew by {n} MB. Blocks had an average size of {n.nn} KB. The smallest block had a size of {n.nn} KB and the largest one, {n.nn} KB. {any interesting fact about this month's blocks}
